def test_command_arg_function_call_with_args_with_plain_tkinter(lint):
...
def test_command_arg_function_call_with_args_with_ttk(lint):
...
def test_command_arg_function_call_with_args_in_config(lint):
...
def test_bind_function_call_with_args(lint):
